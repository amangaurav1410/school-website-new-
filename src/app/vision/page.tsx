        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
          ...
          <section className="relative py-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Vision</span>
              </motion.h1>
              <motion.p
          ...
          <section className="py-24 bg-white">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black mb-8" style={{ fontFamily: '"Raleway", sans-serif', color: '#1A1A1A' }}>
                  Our Commitment to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Excellence</span>
                </h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black mb-6" style={{ fontFamily: '"Raleway", sans-serif', color: '#1A1A1A' }}>
                  Pillars of Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Vision</span>
                </h2>
          ...
          <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black mb-6" style={{ fontFamily: '"Raleway", sans-serif', color: '#1A1A1A' }}>
                  Long-term <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Goals</span>
                </h2>
              </motion.div>
          ...
          <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black mb-6" style={{ fontFamily: '"Raleway", sans-serif', color: '#1A1A1A' }}>
                  Our Path <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Forward</span>
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black mb-6" style={{ fontFamily: '"Raleway", sans-serif', color: '#1A1A1A' }}>
                  Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Impact</span>
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                <h2 className="text-4xl lg:text-5xl font-black text-white mb-6" style={{ fontFamily: '"Raleway", sans-serif' }}>
                  Be a Part of Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D6B25E] to-[#FFA500]">Journey</span>
                </h2>
